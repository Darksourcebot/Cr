...
from YukkiMusic.utils.database import is_video_allowed, get_served_chats
...
@app.on_message(command("اذاعه صوتيه") & SUDOERS)
async def broadcastaudio(_, message: Message):
