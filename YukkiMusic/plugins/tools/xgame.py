...
GAME_MESSAGE = "⩹━★⊷━𝑺𝑶𝑼𝑹𝑪𝑬 ⛧𝑪𝑹⛧━⊶★━⩺\n\n★¦ سي آر بك عزيزي:\n★¦في قسم العاب سي آر\n\n⩹━★⊷━𝑺𝑶𝑼𝑹𝑪𝑬 ⛧𝑪𝑹⛧━⊶★━⩺"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
        InlineKeyboardButton ('★¦العاب سي آر', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('𝑺𝑶𝑼𝑹𝑪𝑬 ⛧𝑪𝑹⛧⚡️', url =f"https://t.me/P_OUV")              
                 ],[
...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "⩹━★⊷━𝑺𝑶𝑼𝑹𝑪𝑬 ⛧𝑪𝑹⛧━⊶★━⩺\n\nسي آر بك في قسم العاب سي آر 3D\n\n⩹━★⊷━𝑺𝑶𝑼𝑹𝑪𝑬 ⛧𝑪𝑹⛧━⊶★━⩺"
             ...
             await CallbackQuery.edit_message_text( 
               ...
               RETURN_GAME = "⩹━★⊷━𝑺𝑶𝑼𝑹𝑪𝑬 ⛧𝑪𝑹⛧━⊶★━⩺\n\n★¦سي آر بك في قسم العاب سي آر\n★¦اختار ما تشاء من الالعاب مسليه وستمتع بها\n\n⩹━★⊷━𝑺𝑶𝑼𝑹𝑪𝑬 ⛧𝑪𝑹⛧━⊶★━⩺" 
